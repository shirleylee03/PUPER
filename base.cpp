...
double get_timeSub(struct timespec time1,struct timespec time2){
    double ts1=time1.tv_sec;
    double ts2=time2.tv_sec;
    ts1+=(double)(time1.tv_nsec/1000000)/1000.0;
    ts2+=(double)(time2.tv_nsec/1000000)/1000.0;
